  ...
  */
  ...
  export interface TelegramDelegate<ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> {
    ...
    **/
     ...
     *     
    **/
    createMany<T extends TelegramCreateManyArgs<ExtArgs>>(
      args?: SelectSubset<T, TelegramCreateManyArgs<ExtArgs>>
   ...
   * Telegram createMany
   */
  export type TelegramCreateManyArgs<ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> = {
    /**
